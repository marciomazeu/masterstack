...
namespace MasterStack.Migrations
{
    ...
    [Migration("20260917230745_AddAuthorFieldsToUser")]
    partial class AddAuthorFieldsToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MasterStack.Models.JobApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MasterStack.Models.JobPosting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MasterStack.Models.ApplicationUser", b =>
                {
                    b.HasOne("MasterStack.Models.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("MasterStack.Models.JobApplication", b =>
                {
                    b.HasOne("MasterStack.Models.ApplicationUser", "Candidate")
                        .WithMany("Applications")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MasterStack.Models.JobPosting", "JobPosting")
                        .WithMany("Applications")
            ...
            modelBuilder.Entity("MasterStack.Models.JobPosting", b =>
                {
                    ...
                    b.HasOne("MasterStack.Models.ApplicationUser", "Recruiter")
                        .WithMany()
